...
if($_POST)
{
    $to_Email       = "sixxdigits@gmail.com"; // Replace with recipient email address
	$subject        = 'Message from website '.$_SERVER['SERVER_NAME']; //Subject line for emails
    
    $host           = "smtp-relay.gmail.com"; // Your SMTP server. For example, smtp.mail.yahoo.com
    $username       = "barz.hlmg1@gmail.com"; //For example, your.email@yahoo.com
    $password       = "webewinning10"; // Your password
